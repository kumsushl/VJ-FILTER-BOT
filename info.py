...
PICS = (environ.get('PICS', 'https://envs.sh/RDC.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001532885306') # give your force subscribe channel id here else leave it blank
